...
//       return res.status(403).json({
//         message: 'Please complete your profile first (upload documents and provide details)'
//       });
//     }
//     next();
//   } catch (error) {
...
// // (اختياري) إذا أردت الاحتفاظ بـ requireSubscription
// const requireSubscription = async (req, res, next) => {
//   try {
//     const provider = await ProviderUser.findById(req.user.id);
//     if (!provider) {
...
// module.exports = { authMiddleware, requireProfileComplete, requireSubscription };